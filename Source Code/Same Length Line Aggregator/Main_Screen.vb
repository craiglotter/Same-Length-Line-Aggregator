...
Public Class Main_Screen
    ...
    Private required_operator As String = "="
    ...
    Private Sub Main_Screen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            InputTargetLength_Textbox.Text = My.Settings.InputTargetLength_Textbox
            InputTargetLength_Textbox.Select(0, 0)

            InputTargetOperator_ComboBox.Text = My.Settings.InputTargetOperator_ComboBox
    ...
    Private Sub Main_Screen_Close(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
            ...
            My.Settings.InputTargetLength_Textbox = InputTargetLength_Textbox.Text
            My.Settings.InputTargetOperator_ComboBox = InputTargetOperator_ComboBox.Text
            My.Settings.Save()
        Catch ex As Exception
    ...
    Private Sub StartWorker()
        Try
            ...
            required_operator = InputTargetOperator_ComboBox.Text
            ...
            BackgroundWorker1.RunWorkerAsync(InputTargetLength_Textbox.Text)
    ...
    Private Sub Controls_Enabler(ByVal action As String)
        Select Case action.ToLower
            Case "run"
                ...
                Me.InputTargetLength_Textbox.Enabled = False
                Me.InputTargetFileType_Textbox.Enabled = False
                Me.InputTargetOperator_ComboBox.Enabled = False
            ...
            Case "stop"
                ...
                Me.InputTargetLength_Textbox.Enabled = True
                Me.InputTargetFileType_Textbox.Enabled = True
                Me.InputTargetOperator_ComboBox.Enabled = True
    ...
    Function MainWorkerFunction(ByVal worker As BackgroundWorker, ByVal e As DoWorkEventArgs) As String
        ...
        Try
            ...
            ' Dim inputfile As String = Me.InputTargetFile_Textbox.Text
            ' Dim required_operator As String = Me.InputTargetOperator_ComboBox.Text
            ' Dim required_length As String = Me.InputTargetLength_Textbox.Text
            ...
            If finfo.Exists = True Then
                ...
                While reader.Peek <> -1
                    ...
                    Select Case required_operator
                        Case "="
                            If lineread.Length = InputTargetLength_Textbox.Text Then
    ...
    Private Sub InputTargetLength_Textbox_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles InputTargetLength_Textbox.TextChanged
        If IsNumeric(InputTargetLength_Textbox.Text) = False Then
            InputTargetLength_Textbox.Text = "0"
        End If
    End Sub
End Class
